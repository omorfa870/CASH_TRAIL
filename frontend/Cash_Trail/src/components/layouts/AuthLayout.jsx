...
const AuthLayout = ({ children }) => {
  return (
    <div className="w-screen h-screen flex">
      ...
      {/* Right Section */}
      <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-image bg-no-repeat bg-center overflow-hidden p-8 relative">
        ...
        <img
         src={card2}
         className="w-64 lg:w-[90%] absolute top-1/2 -translate-y-1/2 shadow-blue-400/15"
         alt="Card"
        />
